...
public class EntityIMEgg extends EntityIMMob {
	...
	private static final DataParameter<Byte> META_HATCHED = EntityDataManager.<Byte>createKey(EntityIMEgg.class,
	...
	public void onEntityUpdate() {
		...
		} else if ((!this.hatched) && (this.getDataManager().get(META_HATCHED) == 1)) {
