...
{
	private static final ResourceLocation texture_T1 = new ResourceLocation(Reference.MODID + ":textures/throwerT1.png");
	private static final ResourceLocation texture_T2 = new ResourceLocation(Reference.MODID + ":textures/throwerT2.png");
