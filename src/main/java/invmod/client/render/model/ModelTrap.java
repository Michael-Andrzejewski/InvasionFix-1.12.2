...
public class ModelTrap extends ModelBase {
	...
	public ModelTrap() {
		...
		this.coreRift = new ModelRenderer(this, 6, 13);
		this.coreRift.addBox(0.0F, 0.0F, 0.0F, 4, 2, 4);
		this.coreRift.setRotationPoint(-2.0F, -2.0F, -2.0F);
		this.coreRift.setTextureSize(32, 32);
		this.coreRift.mirror = true;

		this.CoreFire = new ModelRenderer(this, 6, 7);
		...
		this.CorePoison = new ModelRenderer(this, 6, 1);
		this.CorePoison.addBox(0.0F, 0.0F, 0.0F, 4, 2, 4);
		this.CorePoison.setRotationPoint(-2.0F, -2.0F, -2.0F);
		this.CorePoison.setTextureSize(32, 32);
		this.CorePoison.mirror = true;

		// setRotation(this.coreRift, 0.0F, 0.0F, 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5, boolean isEmpty,
			int type) {
