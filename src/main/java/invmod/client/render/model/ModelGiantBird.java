...
public class ModelGiantBird extends ModelBase{
	...
	public ModelGiantBird(float par1){
		...
		this.upperBeak.addBox(-2.5F, -1.0F, -3.0F, 5, 2, 6);
		this.upperBeak.setRotationPoint(0.0F, -0.8F, -10.0F);
		this.upperBeakTip = new ModelRenderer(this, 70, 118);
		this.upperBeakTip.setTextureSize(128, 128);
		this.upperBeakTip.addBox(-1.0F, -1.0F, -1.0F, 2, 2, 2);
		this.upperBeakTip.setRotationPoint(0.0F, 0.0F, -4.0F);
		this.lowerBeak = new ModelRenderer(this, 78, 118);
		this.lowerBeak.setTextureSize(128, 128);
		this.lowerBeak.addBox(-2.5F, -1.0F, -3.0F, 5, 2, 6);
		this.lowerBeak.setRotationPoint(0.0F, 1.5F, -10.0F);
		this.lowerBeakTip = new ModelRenderer(this, 76, 121);
		this.lowerBeakTip.setTextureSize(128, 128);
		this.lowerBeakTip.addBox(-1.0F, -0.5F, -1.0F, 2, 1, 2);
		this.lowerBeakTip.setRotationPoint(0.0F, -0.5F, -4.0F);
		this.headFeathers = new ModelRenderer(this, -5, 121);
		this.headFeathers.setTextureSize(128, 128);
		this.headFeathers.addBox(-3.5F, 0.0F, -0.5F, 7, 0, 5);
		this.headFeathers.setRotationPoint(0.0F, -5.0F, 0.0F);
		this.backNeckFeathers = new ModelRenderer(this, -7, 108);
		this.backNeckFeathers.setTextureSize(128, 128);
		this.backNeckFeathers.addBox(-4.0F, 0.0F, -1.5F, 8, 0, 7);
		this.backNeckFeathers.setRotationPoint(0.0F, -3.0F, 5.0F);
		this.leftNeckFeathers = new ModelRenderer(this, -6, 115);
		this.leftNeckFeathers.setTextureSize(128, 128);
		this.leftNeckFeathers.addBox(-3.0F, 0.0F, -1.0F, 6, 0, 6);
		this.leftNeckFeathers.setRotationPoint(4.0F, -3.0F, 2.0F);
		this.rightNeckFeathers = new ModelRenderer(this, -6, 115);
		this.rightNeckFeathers.setTextureSize(128, 128);
		this.rightNeckFeathers.addBox(-3.0F, 0.0F, -1.0F, 6, 0, 6);
		this.rightNeckFeathers.setRotationPoint(-4.0F, -3.0F, 2.0F);
		...
		this.neck3.addChild(this.leftNeckFeathers);
		this.neck3.addChild(this.rightNeckFeathers);
		this.neck3.addChild(this.backNeckFeathers);
		...
		setRotation(this.headFeathers, 0.38F, 0.0F, 0.0F);
		setRotation(this.backNeckFeathers, -1.11F, 0.0F, 0.0F);
		setRotation(this.leftNeckFeathers, -0.85F, -1.87F, 0.39F);
		setRotation(this.rightNeckFeathers, -0.85F, 1.87F, -0.39F);
	...
	public void setFlyingAnimations(AnimationState wingState, AnimationState legState, float roll, float headYaw, float headPitch, float parTick){
		...
		if (wingAction == AnimationAction.WINGFLAP){
			...
			ModelRenderer tmp208_205 = this.rightThigh; tmp208_205.rotateAngleX = ((float)(tmp208_205.rotateAngleX + MathHelper.cos(flapCycle * 3.141593F * 2.0F) * 0.08726646324990228D));
			ModelRenderer tmp238_235 = this.leftThigh; tmp238_235.rotateAngleX = ((float)(tmp238_235.rotateAngleX + MathHelper.cos(flapCycle * 3.141593F * 2.0F) * 0.08726646324990228D));
			ModelRenderer tmp268_265 = this.tail; tmp268_265.rotateAngleX = ((float)(tmp268_265.rotateAngleX + MathHelper.cos(flapCycle * 3.141593F * 2.0F) * 0.03490658588512815D));
		}
